...
def main(driver):
    # try:
        ...
        try:
            ...
            cookies_button = wait.until(
                EC.element_to_be_clickable(
                    (By.CLASS_NAME, "cookie-banner__confirm-button")
                )
            )
        ...
        for grade in grades:
            ...
            value = (
                grade.find("div", class_="niche__grade")
                .text.strip()
                .replace("\xa0", " ")
            )
        ...
        # Athletic Conference
        athletic_conference = soup.find_all(class_="scalar__value")[1].get_text(
            strip=True
        )
        ...
        for item in ranking_items:
            ...
            ranking_name = item.find(
                "div", class_="rankings__collection__name"
            ).get_text()
        ...
        if admissions_statistics_section:
            ...
            submitting_sat = (
                admissions_statistics_section.find(
                    "div", string="Students Submitting SAT"
                )
                .find_next_sibling("div", class_="scalar__value")
                .get_text(strip=True)
            )
            ...
            students_submitting_act = (
                admissions_statistics_section.find(
                    "div", string="Students Submitting ACT"
                )
                .find_next_sibling("div", class_="scalar__value")
                .get_text(strip=True)
            )
        ...
        if admissions_requirements_section:
            ...
            college_prep_courses = (
                admissions_requirements_section.find(
                    "div", string="College Prep Courses"
                )
                .find_next_sibling("div", class_="fact__table__row__value")
                .get_text(strip=True)
            )
        ...
        # Net Price
        net_price_label = cost_page_soup.find("div", class_="scalar__label", string="Net Price")
        ...
        if students_receiving_aid_element:
            students_receiving_aid_value = (
                students_receiving_aid_element.find_next_sibling(
                    "div", class_="scalar__value"
                ).get_text(strip=True)
            )
        ...
        if average_meal_plan_cost_element:
            average_meal_plan_cost_value = (
                average_meal_plan_cost_element.find_next_sibling(
                    "div", class_="scalar__value"
                ).get_text(strip=True)
            )
        ...
        if out_of_state_tuition_element:
            out_of_state_tuition_value_element = out_of_state_tuition_element.find_next_sibling(
                "div", class_="scalar__value"
            )
            out_of_state_tuition_value = out_of_state_tuition_value_element.get_text(strip=True)
            cost_data["out_of_state_tuition"] = out_of_state_tuition_value

        # Tuition Guarantee Plan
        tuition_guarantee_value_element = out_of_state_tuition_value_element.find_next(
            "div", class_="scalar__value"
        )
        ...
        graduation_rate_element = academics_page_soup.find("div", class_="scalar__label", string="Graduation Rate")
        ...
        full_time_retention_rate_value_element = graduation_rate_value_element.find_next("div", class_="scalar__label").find_next_sibling("div")
        academics_data["full_time_retention_rate"] = full_time_retention_rate_value_element.text
        
        part_time_retention_rate_value_element = full_time_retention_rate_value_element.find_next("div", class_="scalar__label").find_next_sibling("div")
        academics_data["part_time_retention_rate"] = part_time_retention_rate_value_element.text

        academic_calendar_value_element = part_time_retention_rate_value_element.find_next("div", class_="scalar__label").find_next_sibling("div")
        academics_data["academic_calendar"] = academic_calendar_value_element.text

        research_funding_student_value_element = academic_calendar_value_element.find_next("div", class_="scalar__label").find_next_sibling("div")
        academics_data["research_funding_student"] = research_funding_student_value_element.text
        
        non_traditional_learning_elements = academics_page_soup.find_all("li", class_="fact__table__row")[:3]
        academics_data["evening_degree_programs"] = non_traditional_learning_elements[0].find("div", class_="fact__table__row__value").text
        academics_data["teacher_certification"] = non_traditional_learning_elements[1].find("div", class_="fact__table__row__value").text
        academics_data["study_abroad"] = non_traditional_learning_elements[2].find("div", class_="fact__table__row__value").text

        faculty = {}

        faculty_section = academics_page_soup.find("section", {"id": "about-the-professors"})
        student_faculty_ratio_element = faculty_section.find("div", class_="scalar__label", string="Student Faculty Ratio")
        ...
        female_professors_value_element = student_faculty_ratio_value_element.find_next("div", class_="scalar__label").find_next_sibling("div")
        faculty["female_professors"] = female_professors_value_element.text

        male_professors_value_element = female_professors_value_element.find_next("div", class_="scalar__label").find_next_sibling("div")
        faculty["male_professors"] = male_professors_value_element.text

        average_professor_salary_value_element = male_professors_value_element.find_next("div", class_="scalar__label").find_next_sibling("div")
        faculty["average_professor_salary"] = average_professor_salary_value_element.text

        faculty_poll_value_element = average_professor_salary_value_element.find_next("div").find("div", class_="poll__single__percent poll__single__percent__label")
